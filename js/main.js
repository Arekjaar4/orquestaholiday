document.addEventListener('DOMContentLoaded', function() {
    ...
    async function loadVideos() {
        try {
            const response = await fetch('https://arekjaar4.github.io/orquestaholiday/data/videos.json');
    ...
    async function cargarRepertorio() {
        try {
            const response = await fetch('https://arekjaar4.github.io/orquestaholiday/data/repertorio.json');
